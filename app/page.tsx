    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-white to-white relative overflow-hidden">
      ...
      <div className="flex flex-col items-center px-6 pt-8">
        ...
        <div className="w-full max-w-sm space-y-4">
          <Button onClick={handleClick} className="w-full h-14 bg-white/95 backdrop-blur-sm text-black hover:bg-white hover:scale-[1.02] transition-all duration-200 rounded-2xl text-lg font-semibold flex items-center justify-between px-6 shadow-lg border border-white/20">
